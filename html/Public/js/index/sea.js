...
seajs._config = {
    ...
    function l() {}
    var g = document,
    i = g.head || g.getElementsByTagName("head")[0] || g.documentElement,
    ...
    j = 536 > Number(o.replace(/.*AppleWebKit\/(\d+)\..*/, "$1")),
    q = 0 < o.indexOf("Firefox") && !("onload" in document.createElement("link"))
    ...
    function e(a, d) {
        return b.isString(a) ? c._resolve(a, d) : b.map(a,
        function(a) {
            return e(a, d)
        })
    }
    function l(a, t) {
        var e = b.parseMap(a);
        v[e] ? (f[a] = f[e], t()) : q[e] ? u[e].push(t) : (q[e] = !0, u[e] = [t], c._fetch(e,
        function() {
            v[e] = !0;
            var d = f[a];
    ...
    function m(a) {
        var c = a.uri;
        return b.filter(a.dependencies,
        function(a) {
            h = [c];
            if (a = r(f[a])) h.push(c),
            b.log("Found circular dependencies:", h.join(" --\> "), void 0);
            return ! a
        })
    }
    function r(a) {
    ...
    c.prototype._load = function(a, d) {
        function e(a) { (a || {}).status < j.READY && (a.status = j.READY);
            0 === --i && d()
        }
        var x = b.filter(a,
        function(a) {
        ...
        h = 0; h < g; h++)(function(a) {
            function b() {
                d = f[a];
                if (d.status >= j.SAVED) {
                    var t = m(d);
                    t.length ? c.prototype._load(t,
                    function() {
                        e(d)
                    }) : e(d)
                } else e()
    ...
    c._define = function(a, d, g) {
        ...
        1 === h ? (g = a, a = void 0) : 2 === h && (g = d, d = void 0, b.isArray(a) && (d = a, a = void 0)); ! b.isArray(d) && b.isFunction(g) && (d = b.parseDependencies(g.toString()));
        var h = {
            id: a,
            dependencies: d,
            factory: g
        ...
        if (m = a ? e(a) : i) {
            ...
            h = c._save(m, h);
            if (i) {
                if ((f[i] || {}).status === j.FETCHING) f[i] = h,
                h.realUri = i
            } else s || (s = h)
        } else n = h
    };
    ...
    c._find = function(a) {
        ...
        b.forEach(b.keys(f),
        function(d) {
            if (b.isString(a) && -1 < d.indexOf(a) || b.isRegExp(a) && a.test(d)) d = f[d],
            d.exports && c.push(d.exports)
        });
        return c
    };
    ...
    c._save = function(a, d) {
        ...
        i.status < j.SAVED && (i.id = d.id || a, i.dependencies = e(b.filter(d.dependencies || [],
        function(a) {
            return !! a
...
})(seajs, seajs._util, seajs._config); (function(a, b, d) {
    var c = "seajs-ts=" + b.now(),
    e = document.getElementById("seajsnode");
    e || (e = document.getElementsByTagName("script"), e = e[e.length - 1]);
    var l = e && b.getScriptAbsoluteSrc(e) || b.pageUri,
    l = b.dirname(function(a) {
        if (a.indexOf("??") === -1) return a;
        var c = a.split("??"),
        a = c[0],
        c = b.filter(c[1].split(","),
        function(a) {
    ...
    b.forEach(function() {
        var a = [],
        e = d.location.search,
        e = e.replace(/(seajs-\w+)(&|$)/g, "$1=1$2"),
        e = e + (" " + document.cookie);
        e.replace(/seajs-(\w+)=[1-9]/g,
        function(b, d) {
            a.push(d)
        });
        return b.unique(a)
...
})(seajs, seajs._util, this); (function(a, b, d) {
    var c = a._seajs;
    if (c && !c.args) d.seajs = a._seajs;
        ...
        e = 0; e < b.length; e += 2) a[c[b[e]]].apply(a, b[e + 1]);
        d.define.cmd = {};
        delete a.define;
        delete a._util;
        delete a._config;
