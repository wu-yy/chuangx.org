...
(function(jq){
	...
	posterTvGrid.prototype = {
		...
		initContent: function(){
			...
			this.parent.find(".contentHolderUnit:nth-child("+pre+")").css({opacity: 1, left: this.preLeft+'px',height: '200px', width: '448px', zIndex: 0, marginTop: '30px'});
			...
			this.parent.find(".contentHolderUnit:nth-child("+next+")").css({opacity: 1, left: this.nextLeft+'px',height: '200px', width: '448px', zIndex: 0, marginTop: '30px'});
		...
		turnpage: function(page, dir){
			...
			var run = function(page, dir, t){
				...
				if(dir == 'left'){					
					...
					_this.parent.find(".contentHolderUnit:nth-child("+pre+")").animate({opacity: 1, left: _this.preLeft+'px', height: '200px', width: '448px', zIndex: 2, marginTop: '30px'}, t);
					...
					_this.parent.find(".contentHolderUnit:nth-child("+next+")").animate({opacity: 1, left: _this.nextLeft+'px', height: '200px', width:"448px", zIndex: 2, marginTop: '30px'}, t);
