(function($) {
    $.fn.jquizzy = function(settings) {
        var defaults = {
            questions: null,                        
            resultComments: {
                type1: '<div><p style="margin-bottom:15px">你是<span style="color:#32CD32"><b>绿色</b></span>性格：“培养型”–“以人为本者”</p><p style="margin-bottom:15px">你擅长欣赏与感激他人，乐于表达，积极达观，开朗正向。</p><p style="margin-bottom:15px">你尊重人的价值，有同理心、关心他人。</p><p style="margin-bottom:15px">你是创业团队中的积极氛围创造者！</p></div>',
                type2: '<div><p style="margin-bottom:15px">你是<span style="color:#0000CD"><b>蓝色</b></span>性格：“展望型”–“创意创造者”</p><p style="margin-bottom:15px">你擅长思考与想像，能够自然地产生创意。</p><p style="margin-bottom:15px">你以创意相聚，崇尚自由，争做最好。</p><p style="margin-bottom:15px">你是创业团队中的先行者和创意者！</p></div>',
                type3: '<div><p style="margin-bottom:15px">你是<span style="color:#FFA500"><b>黄色</b></span>性格：“包融型”–“团队的凝聚者”</p><p style="margin-bottom:15px">你喜欢交际，自然地给人以归属感、包容感。</p><p style="margin-bottom:15px">你能够营造融洽的关系，追求和谐的团队合作。</p><p style="margin-bottom:15px">你是创业团队中的融合剂！</p></div>',
                type4: '<div><p style="margin-bottom:15px">你是<span style="color:#FF4500"><b>橙色</b></span>性格：“指导型”–“体系的构建者”</p><p style="margin-bottom:15px">你注重流程和组织架构，追求结果的确定性。</p><p style="margin-bottom:15px">你能够规范地管理人，将工作有条不紊地推向你的预期。</p><p style="margin-bottom:15px">你是创业团队中的扎实推进者！</p></div>'
            }
        };
        ...
        finishFob='<div class="center"><input type="button" id="finish" value="查看结果"/></div>',
        contentFob = '',
