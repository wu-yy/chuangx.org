					...
					for(var x in data)
						{
									...
									var str="<a href='javascript:;' name='w_kecheng' onClick='log_url2(\""+window.bofang+"cid/"+b+"\",\"phone_course_list\");'> <li><image src='"+window.root+image+"'/><div class='w_right'><p>"+title+"</p><p style='color:#999;'>"+teacher_name+"</p></div></li></a>"+str;
									a=a+1;
						}
