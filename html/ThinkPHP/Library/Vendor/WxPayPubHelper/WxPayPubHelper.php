...
class Common_util_pub
{
	...
	function __construct($config) {
		...
		if(isset($config['appid'])){
			...
			//=======【基本信息设置】=====================================
			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
			$this->APPID = 'wxb15b4968519a05bc';
			//受理商ID，身份标识
			$this->MCHID = '1366575002';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
			$this->KEY = 'jkl342ujskl0gtljksogdlglddfghfui';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
			$this->APPSECRET = 'd09d5d51ee0706f5f54f668cb5867aff';		
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径
			$this->SSLCERT_PATH = '/var/www/html/ThinkPHP/Library/Vendor/WxPayPubHelper/cacert/apiclient_cert.pem';
			$this->SSLKEY_PATH = '/var/www/html/ThinkPHP/Library/Vendor/WxPayPubHelper/cacert/apiclient_key.pem';
			//商户名称
			$this->COMPANY = '创业学院';
			//异步通知url，商户根据实际开发过程设定
		    $this->NOTIFY_URL = 'http://test.chuangx.org/index.php/Home/Pay/weixin_result/';
...
class JsApi_pub extends Common_util_pub
{
	 ...
	 */
	public function GetEditAddressParameters($token)
	{
	
	 //$token='jGSXBDEVDEQxRO1MgXxFLaYn8ZkLnAiyvGWRoFjMm84ucHUBPApucSz9R22ezAPnjENiT4JjSNssM3E_Qd3JazHtUJI3PuFVOUq4gEVBugAI2EenWv11HOcPjxPq4bLrLMUgAAACDL';
	     $data = array();
