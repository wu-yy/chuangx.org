...
function k_jie_width()
{
	var width=window.nu*177;
	
	document.getElementById('k_jie').style.width=width;	
}
function jump(zhangjie_id)
{
	xiaojie_log(zhangjie_id);
	
	window.location.href=window.url+'phone_voidplay/zid/'+zhangjie_id; 	
}
function get_xiaojie1(zhangjie_id)
{
	$.ajax({
            url:window.url+'p_xiaojie',
            async:false, 
